      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-full">
        {plans.map((plan, idx) => (
          <div 
            ...
            role="button"
            className={`p-5 rounded-[1.5rem] border-2 transition-all cursor-pointer flex flex-col justify-between active:scale-[0.98] ${
              plan.popular 
          ...
          >
            <div>
              <div className="flex justify-between items-start mb-2">
                ...
                } text-[11px] px-2.5 py-1 rounded-full font-black tracking-wide`}>
                  {plan.price}
                </span>
              </div>
